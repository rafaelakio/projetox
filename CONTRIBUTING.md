...
- Verifique se o bug já não foi reportado nas [Issues](https://github.com/rafaelakio/projetox/issues)
- Se não encontrar, [crie uma nova issue](https://github.com/rafaelakio/projetox/issues/new?template=bug_report.md)
...
- Verifique se a sugestão já não existe nas [Issues](https://github.com/rafaelakio/projetox/issues)
- [Crie uma nova issue](https://github.com/rafaelakio/projetox/issues/new?template=feature_request.md)
...
- Abra uma [Discussion](https://github.com/rafaelakio/projetox/discussions)
- Entre em contato via [Issues](https://github.com/rafaelakio/projetox/issues)
